...
function(sbeUpdateUrlInContextFile contextFile newUrl oldUrl)
    file(READ ${contextFile} context)
    string(REPLACE "${oldUrl}" "${newUrl}" context "${context}")
    file(WRITE ${contextFile} ${context})
endfunction()

function(sbeAddUrlInContextFile contextFile name url)
    file(READ ${contextFile} context)
    string(REGEX REPLACE "(set[ \t\n\r]*\\([ \t\n\r]*Context)" "\\1\nPackage ${name} Url ${url}" context "${context}") 
    file(WRITE ${contextFile} ${context})
endfunction()
