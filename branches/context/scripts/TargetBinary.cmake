    ...
    if(DEFINED prop_LinkOwnLibraries)
        foreach(ownLib ${prop_LinkOwnLibraries}) 
            ...
            if(isGeneratedLibrary)
                ...
                target_link_libraries(${prop_Name} LINK_PRIVATE ${location})
                ...
                target_link_libraries(${prop_Name} LINK_PRIVATE ${ownLib})
            endif()
        endforeach()
    endif()
...
function(sbeAddTestExecutable)
    ...
    if(DEFINED prop_LinkOwnLibraries)
        target_link_libraries(${prop_Name} LINK_PRIVATE ${prop_LinkOwnLibraries})
    endif()
